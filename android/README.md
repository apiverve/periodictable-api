...
```gradle
dependencies {
    implementation 'com.github.apiverve:periodictable-api:1.1.14'
}
```
...
```java
import com.apiverve.periodictable.PeriodicTableAPIClient;
import com.apiverve.periodictable.APIResponse;
import com.apiverve.periodictable.APIException;

// Initialize the client
PeriodicTableAPIClient client = new PeriodicTableAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("name", "hydrogen");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/periodictable](https://docs.apiverve.com/ref/periodictable)
...
- **Documentation:** [https://docs.apiverve.com/ref/periodictable](https://docs.apiverve.com/ref/periodictable)
- **Issues:** [GitHub Issues](https://github.com/apiverve/periodictable-api/issues)
