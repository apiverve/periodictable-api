...
// Request contains the parameters for the Periodic Table API.
//
// Parameters:
...
// ResponseData contains the data returned by the Periodic Table API.
type ResponseData struct {
	...
	Xpos int `json:"xpos"`
	Ypos int `json:"ypos"`
	Wxpos int `json:"wxpos"`
	Wypos int `json:"wypos"`
