// Package periodictable provides a Go client for the Periodic Table API.
//
// For more information, visit: https://apiverve.com/marketplace/periodictable?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/periodictable"
	defaultTimeout = 30 * time.Second
)

// Client is the Periodic Table API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Periodic Table API client.
...
// Execute makes a request to the Periodic Table API with typed parameters.
//
...
//   - name (required): string - The name of the chemical element to get information about
