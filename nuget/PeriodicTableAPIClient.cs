...
namespace APIVerve.API.PeriodicTable
{
    ...
    /// <summary>
    /// Client for the PeriodicTable API
    /// </summary>
...
#endif
    {
        ...
        public PeriodicTableAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public PeriodicTableAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public PeriodicTableAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        private void ValidateParams(PeriodicTableQueryOptions options)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(PeriodicTableQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(PeriodicTableQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(PeriodicTableQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(PeriodicTableQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(PeriodicTableQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
